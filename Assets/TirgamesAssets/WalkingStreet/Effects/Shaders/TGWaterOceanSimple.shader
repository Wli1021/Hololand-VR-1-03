...
Shader "Tirgames/WaterOceanSimple"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_WaterNormal("Water Normal", 2D) = "bump" {}
		_NormalScale("Normal Scale", Float) = 0
		_WaterColor("WaterColor", Color) = (0,0,0,0)
		_WaterMetallic("Water Metallic", Float) = 0
		[ASEEnd]_WaterSmoothness("Water Smoothness", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 fetchOpaqueVal65 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( float3( (ase_grabScreenPosNorm).xy ,  0.0 ) + temp_output_24_0 ).xy ), 1.0 );
				float4 lerpResult93 = lerp( _WaterColor , fetchOpaqueVal65 , float4( 0,0,0,0 ));
...
/*ASEBEGIN
Version=19102
Node;AmplifyShaderEditor.CommentaryNode;151;-935.9057,-1082.484;Inherit;False;1281.603;457.1994;Waves;7;19;23;24;21;22;17;48;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-557.3063,-795.3858;Float;False;Property;_NormalScale;Normal Scale;1;0;Create;True;0;0;0;False;0;False;0;0.7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;150;359.951,-575.5718;Inherit;False;985.6011;418.6005;Reflections;4;96;65;164;165;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;17;-256.3054,-814.2847;Inherit;True;Property;_WaterNormal;Water Normal;0;0;Create;True;0;0;0;False;0;False;-1;None;82ba5550c656dc54595e5382413d7deb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;96;1;24;0
WireConnection;65;0;96;0
WireConnection;93;0;12;0
WireConnection;93;1;65;0
WireConnection;167;0;93;0
WireConnection;167;1;24;0
WireConnection;167;3;104;0
WireConnection;167;4;26;0
ASEEND*/
//CHKSM=8E87D0B6261A8E66F3CAE244F1F85FAAC57E259E